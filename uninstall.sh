#!/bin/bash
# https://github.com/JaKooLit / https://github.com/seyboo #
# KooL-style Fedora-Sway uninstall script #
...
# Welcome Message
whiptail --title "Fedora-Sway KooL-style Dots Uninstall Script" --yesno \
"Hello! This script will uninstall KooL-style Sway packages and configs.
...
packages=(
    ...
    "swaybg" "Sway background daemon" "off"
    "swayidle" "Sway idle daemon" "off"
    "swaylock" "Sway lockscreen" "off"
    ...
    "wlsunset" "day/night gamma adjustment" "off"
    "xdg-desktop-portal-wlr" "wlr screen share portal" "off"
    "lxqt-policykit" "polkit agent" "off"
    "yad" "dialog box" "off"
...
printf "\n%.0s" {1..1}
echo -e "$MAGENTA Sway and related components have been uninstalled.$RESET"
